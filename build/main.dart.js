...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = init.G,
        t2 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#itemInput"));
      if (t2 == null)
        t2 = A._asJSObject(t2);
      $.___itemInput._value = t2;
      t2 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#itemNameInput"));
      if (t2 == null)
        t2 = A._asJSObject(t2);
      $.___itemNameInput._value = t2;
      t2 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#priceInput"));
      if (t2 == null)
        t2 = A._asJSObject(t2);
      $.___priceInput._value = t2;
      t2 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#quantityInput"));
      if (t2 == null)
        t2 = A._asJSObject(t2);
      $.___quantityInput._value = t2;
      t2 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#currencyInput"));
      if (t2 == null)
        t2 = A._asJSObject(t2);
      $.___currencyInput._value = t2;
      t2 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#searchInput"));
      if (t2 == null)
        t2 = A._asJSObject(t2);
      $.___searchInput._value = t2;
      t2 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#addButton"));
      if (t2 == null)
        t2 = A._asJSObject(t2);
      $.___addButton._value = t2;
      t2 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#ordersBody"));
      if (t2 == null)
        t2 = A._asJSObject(t2);
      $.___ordersBody._value = t2;
      t2 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#statusMessage"));
      if (t2 == null)
        t2 = A._asJSObject(t2);
      $.___statusMessage._value = t2;
      t2 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#prevPageButton"));
      if (t2 == null)
        t2 = A._asJSObject(t2);
      $.___prevPageButton._value = t2;
      t2 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#nextPageButton"));
      if (t2 == null)
        t2 = A._asJSObject(t2);
      $.___nextPageButton._value = t2;
      t1 = A._asJSObjectQ(A._asJSObject(t1.document).querySelector("#pageInfo"));
      if (t1 == null)
        t1 = A._asJSObject(t1);
      $.___pageInfo._value = t1;
      A._loadInitialOrders();
      $.___addButton._readField$0().onclick = A._functionToJS1(new A.main_closure());
      $.___searchInput._readField$0().oninput = A._functionToJS1(new A.main_closure0());
      $.___prevPageButton._readField$0().onclick = A._functionToJS1(new A.main_closure1());
      $.___nextPageButton._readField$0().onclick = A._functionToJS1(new A.main_closure2());
      A._renderOrders();
      A._renderPagination();
    },
    _loadInitialOrders() {
      var decoded, error, t1, exception;
      try {
        decoded = B.C_JsonCodec.decode$2$reviver('[{"Item":"A1000","ItemName":"Iphone 15","Price":1200,"Currency":"USD","Quantity":1},{"Item":"A1001","ItemName":"Iphone 16","Price":1500,"Currency":"USD","Quantity":1}]', null);
        if (!type$.List_dynamic._is(decoded))
          throw A.wrapException(B.FormatException_An2);
        B.JSArray_methods.clear$0($._orders);
        t1 = type$.Order;
        B.JSArray_methods.addAll$1($._orders, J.asMap$0$ax(decoded).get$entries().map$1$1(0, new A._loadInitialOrders_closure(), t1));
        $._filteredOrders = A.List_List$from($._orders, t1);
        $._currentPage = 1;
        A._setStatus("Loaded " + $._orders.length + " orders from JSON.", false);
      } catch (exception) {
        error = A.unwrapException(exception);
        B.JSArray_methods.clear$0($._orders);
        $._filteredOrders = A._setArrayType([], type$.JSArray_Order);
        $._currentPage = 1;
        A._setStatus("Could not parse initial JSON: " + A.S(error), true);
      }
    },
    _handleAddOrder() {
      var t1, t2, updatedJson,
        item = B.JSString_methods.trim$0(A._asString($.___itemInput._readField$0().value)),
        itemName = B.JSString_methods.trim$0(A._asString($.___itemNameInput._readField$0().value)),
        currency = B.JSString_methods.trim$0(A._asString($.___currencyInput._readField$0().value)).toUpperCase(),
        price = A.Primitives_parseDouble(B.JSString_methods.trim$0(A._asString($.___priceInput._readField$0().value))),
        quantity = A.Primitives_parseInt(B.JSString_methods.trim$0(A._asString($.___quantityInput._readField$0().value)), null);
      if (item.length === 0 || itemName.length === 0 || currency.length === 0) {
        A._setStatus("Item, Item Name, and Currency are required.", true);
        return;
      }
      if (price == null || price <= 0) {
        A._setStatus("Price must be a positive number.", true);
        return;
      }
      if (quantity == null || quantity <= 0) {
        A._setStatus("Quantity must be a positive integer.", true);
        return;
      }
      B.JSArray_methods.add$1($._orders, new A.Order($._orders.length === 0 ? 1 : B.JSArray_methods.get$last($._orders).id + 1, item, itemName, price, currency, quantity));
      A._applyFilter(false);
      $._currentPage = A._totalPages();
      A._renderOrders();
      A._renderPagination();
      t1 = A._arrayInstanceType($._orders);
      t2 = t1._eval$1("MappedListIterable<1,Map<String,@>>");
      t1 = A.List_List$_of(new A.MappedListIterable($._orders, t1._eval$1("Map<String,@>(1)")._as(new A._handleAddOrder_closure()), t2), t2._eval$1("ListIterable.E"));
      updatedJson = B.C_JsonCodec.encode$2$toEncodable(t1, null);
      $.___itemInput._readField$0().value = "";
      $.___itemNameInput._readField$0().value = "";
      $.___priceInput._readField$0().value = "";
      $.___quantityInput._readField$0().value = "";
      A._setStatus("Order inserted. Total orders in order.json: " + $._orders.length + " (" + updatedJson.length + " chars).", false);
    },
    _applyFilter(resetPage) {
      var t1, t2,
        keyword = B.JSString_methods.trim$0(A._asString($.___searchInput._readField$0().value)).toLowerCase();
      if (keyword.length === 0)
        $._filteredOrders = A.List_List$from($._orders, type$.Order);
      else {
        t1 = A._arrayInstanceType($._orders);
        t2 = t1._eval$1("WhereIterable<1>");
        t1 = A.List_List$_of(new A.WhereIterable($._orders, t1._eval$1("bool(1)")._as(new A._applyFilter_closure(keyword)), t2), t2._eval$1("Iterable.E"));
        $._filteredOrders = t1;
      }
      if (resetPage)
        $._currentPage = 1;
    ...
    _renderOrders() {
      var t2, t3, emptyRow, emptyCell, start, pageItems, _i, order, row, t4, cell,
        t1 = $.___ordersBody._name;
      for (;;) {
        t2 = $.___ordersBody._value;
        if (t2 === $.___ordersBody)
          A.throwExpression(A.LateError$fieldNI(t1));
        if (!(A._asJSObjectQ(t2.firstChild) != null))
          break;
        t3 = A._asJSObjectQ(t2.firstChild);
        t3.toString;
        A._asJSObject(t2.removeChild(t3));
      }
      t2 = $._filteredOrders;
      t3 = t2.length;
      if (t3 === 0) {
        t1 = init.G;
        emptyRow = A._asJSObject(A._asJSObject(t1.document).createElement("tr"));
        emptyCell = A._asJSObject(A._asJSObject(t1.document).createElement("td"));
        emptyCell.setAttribute("colspan", "7");
        emptyCell.className = "empty";
        emptyCell.textContent = "No matching orders.";
        emptyRow.append(emptyCell);
        $.___ordersBody._readField$0().append(emptyRow);
        return;
      }
      start = ($._currentPage - 1) * 10;
      pageItems = B.JSArray_methods.sublist$2(t2, start, Math.min(start + 10, t3));
      for (t2 = pageItems.length, t3 = init.G, _i = 0; _i < pageItems.length; pageItems.length === t2 || (0, A.throwConcurrentModificationError)(pageItems), ++_i) {
        order = pageItems[_i];
        row = A._asJSObject(A._asJSObject(t3.document).createElement("tr"));
        t4 = B.JSInt_methods.toString$0(order.id);
        cell = A._asJSObject(A._asJSObject(t3.document).createElement("td"));
        cell.textContent = t4;
        row.append(cell);
        cell = A._asJSObject(A._asJSObject(t3.document).createElement("td"));
        cell.textContent = order.item;
        row.append(cell);
        cell = A._asJSObject(A._asJSObject(t3.document).createElement("td"));
        cell.textContent = order.itemName;
        row.append(cell);
        t4 = B.JSInt_methods.toString$0(order.quantity);
        cell = A._asJSObject(A._asJSObject(t3.document).createElement("td"));
        cell.textContent = t4;
        row.append(cell);
        t4 = A._formatPrice(order.price);
        cell = A._asJSObject(A._asJSObject(t3.document).createElement("td"));
        cell.textContent = t4;
        row.append(cell);
        cell = A._asJSObject(A._asJSObject(t3.document).createElement("td"));
        cell.textContent = order.currency;
        row.append(cell);
        row.append(A._deleteCell(order));
        t4 = $.___ordersBody._value;
        if (t4 === $.___ordersBody)
          A.throwExpression(A.LateError$fieldNI(t1));
        t4.append(row);
      }
    ...
    _renderPagination() {
      $.___pageInfo._readField$0().textContent = "Page " + $._currentPage + " / " + A._totalPages();
      $.___prevPageButton._readField$0().disabled = $._currentPage <= 1;
      $.___nextPageButton._readField$0().disabled = $._currentPage >= A._totalPages();
    },
    _goToPreviousPage() {
      var t1 = $._currentPage;
      if (t1 <= 1)
    ...
    _deleteCell(order) {
      var t1 = init.G,
        cell = A._asJSObject(A._asJSObject(t1.document).createElement("td")),
        button = A._asJSObject(A._asJSObject(t1.document).createElement("button"));
      button.className = "delete-btn";
      button.textContent = "Delete";
      button.type = "button";
      button.onclick = A._functionToJS1(new A._deleteCell_closure(order));
      cell.append(button);
      return cell;
    },
    _deleteOrder(id) {
      var t1 = A._arrayInstanceType($._orders)._eval$1("bool(1)")._as(new A._deleteOrder_closure(id));
      $._orders.$flags & 1 && A.throwUnsupportedOperation($._orders, 16);
      B.JSArray_methods._removeWhere$2($._orders, t1, true);
      A._applyFilter(false);
      A._setStatus("Order " + id + " deleted. Remaining: " + $._orders.length + ".", false);
    },
    _totalPages() {
      var t1 = $._filteredOrders.length;
      if (t1 === 0)
        return 1;
      return B.JSNumber_methods.ceil$0(t1 / 10);
    },
    _setStatus(message, isError) {
      var t1 = $.___statusMessage._readField$0();
      t1.textContent = message;
      t1.className = "status " + (isError ? "error" : "success");
    },
    _formatPrice(value) {
      if (B.JSNumber_methods.$mod(value, 1) === 0)
        return B.JSNumber_methods.toStringAsFixed$1(value, 0);
    ...
    _toDouble(value) {
      ...
      if (typeof value == "number")
        return value;
      t1 = A.Primitives_parseDouble(J.toString$0$(value));
      return t1 == null ? 0 : t1;
    },
    _toInt(value) {
      var t1;
      ...
      t1 = A.Primitives_parseInt(J.toString$0$(value), null);
      return t1 == null ? 0 : t1;
    },
    ...
    Order: function Order(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _.id = t0;
      _.item = t1;
      _.itemName = t2;
    ...
    _loadInitialOrders_closure: function _loadInitialOrders_closure() {
    },
    _handleAddOrder_closure: function _handleAddOrder_closure() {
    },
    _applyFilter_closure: function _applyFilter_closure(t0) {
      this.keyword = t0;
    },
    _deleteCell_closure: function _deleteCell_closure(t0) {
      this.order = t0;
    },
    _deleteOrder_closure: function _deleteOrder_closure(t0) {
      this.id = t0;
    },
    _functionToJS1(f) {
      var result;
  ...
  A._ListIndicesIterable.prototype = {
    ...
    elementAt$1(_, index) {
      var t1 = this._backedList.length;
      if (0 > index || index >= t1)
  ...
  A.ListMapView.prototype = {
    $index(_, key) {
      var t1;
      if (A._isInt(key) && key >= 0 && key < this._values.length) {
        t1 = this._values;
  ...
  A._loadInitialOrders_closure.prototype = {
    call$1(entry) {
      var row, t1, t2, t3, t4, t5;
      type$.MapEntry_int_dynamic._as(entry);
      row = entry.value;
      if (!type$.Map_String_dynamic._is(row))
        throw A.wrapException(B.FormatException_P8X);
      t1 = row;
      t2 = t1.$index(0, "Item");
      t2 = B.JSString_methods.trim$0(J.toString$0$(t2 == null ? "" : t2));
      t3 = t1.$index(0, "ItemName");
      t3 = B.JSString_methods.trim$0(J.toString$0$(t3 == null ? "" : t3));
      t4 = A._toDouble(t1.$index(0, "Price"));
      t5 = t1.$index(0, "Currency");
      return new A.Order(entry.key + 1, t2, t3, t4, B.JSString_methods.trim$0(J.toString$0$(t5 == null ? "" : t5)), A._toInt(t1.$index(0, "Quantity")));
    },
    $signature: 6
  };
  A._handleAddOrder_closure.prototype = {
    call$1(e) {
      return type$.Order._as(e).toJson$0();
    },
    $signature: 7
  };
  A._applyFilter_closure.prototype = {
    call$1(order) {
      type$.Order._as(order);
      return A.stringContainsUnchecked(order.itemName.toLowerCase(), this.keyword, 0);
    },
    $signature: 3
  };
  A._deleteCell_closure.prototype = {
    call$1(__wc0_formal) {
      A._asJSObject(__wc0_formal);
      A._deleteOrder(this.order.id);
    },
    $signature: 0
  };
  A._deleteOrder_closure.prototype = {
    call$1(order) {
      return type$.Order._as(order).id === this.id;
    },
    $signature: 3
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.MappedIterator, A.WhereIterator, A.FixedLengthListMixin, A.MapBase, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.Closure, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A._Cell, A.Rti, A._FunctionParameters, A._Type, A.ListBase, A._UnmodifiableMapMixin, A.Codec, A.Converter, A._JsonStringifier, A.StackOverflowError, A.FormatException, A.MapEntry, A.Null, A.StringBuffer, A.Order]);
    ...
    _inheritMany(A.ListIterable, [A.MappedListIterable, A._ListIndicesIterable, A._JsonMapKeyIterable]);
    _inheritMany(A.MapBase, [A.UnmodifiableMapBase, A.JsLinkedHashMap, A._JsonMap]);
    _inherit(A.ListMapView, A.UnmodifiableMapBase);
    _inherit(A.NullError, A.TypeError);
    _inheritMany(A.Closure, [A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.MapBase_entries_closure, A.main_closure, A.main_closure0, A.main_closure1, A.main_closure2, A._loadInitialOrders_closure, A._handleAddOrder_closure, A._applyFilter_closure, A._deleteCell_closure, A._deleteOrder_closure]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      JSArray_Order: findType("JSArray<Order>"),
...
;
    ...
    B.FormatException_An2 = new A.FormatException("Order JSON must be a list.");
    B.FormatException_P8X = new A.FormatException("Each order must be an object.");
  ...
  (function staticFields() {
    ...
    $._orders = A._setArrayType([], type$.JSArray_Order);
    $._filteredOrders = A._setArrayType([], type$.JSArray_Order);
    $.___itemInput = A._Cell$named("_itemInput");
    $.___itemNameInput = A._Cell$named("_itemNameInput");
    $.___priceInput = A._Cell$named("_priceInput");
    $.___quantityInput = A._Cell$named("_quantityInput");
    $.___currencyInput = A._Cell$named("_currencyInput");
    $.___searchInput = A._Cell$named("_searchInput");
    $.___addButton = A._Cell$named("_addButton");
    $.___ordersBody = A._Cell$named("_ordersBody");
    $.___statusMessage = A._Cell$named("_statusMessage");
    $.___prevPageButton = A._Cell$named("_prevPageButton");
    $.___nextPageButton = A._Cell$named("_nextPageButton");
    $.___pageInfo = A._Cell$named("_pageInfo");
    $._currentPage = 1;
  })();
